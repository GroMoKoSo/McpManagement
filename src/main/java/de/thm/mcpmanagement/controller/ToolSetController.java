...
public interface ToolSetController {
    ...
    @Operation(summary = "Get all tool sets", description = "Retrieves a list of all available tool sets.")
    @ApiResponse(responseCode = "200", description = "Successfully retrieved list")
    @GetMapping("/toolsets")
    ToolSet[] getToolSets();

    @Operation(summary = "Get a tool set by ID", description = "Retrieves a single tool set using its unique ID.")
    ...
    @Operation(summary = "Update a tool set", description = "Updates an existing tool set with new specifications or create a new tool set.")
    ...
    @Operation(summary = "Delete a tool set", description = "Deletes a tool set by its ID.")
    ...
    @Operation(summary = "Notify a user's tool set list has changed", description = "Signals that a specific user's tool set list has been updated.")
