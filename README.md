...
```
cd existing_repo
git remote add origin https://git.thm.de/softwarearchitektur-wz-ss24/studentswa2025/enton/mcpmanagement.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.thm.de/softwarearchitektur-wz-ss24/studentswa2025/enton/mcpmanagement/-/settings/integrations)
